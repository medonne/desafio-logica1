...
### ⚔️ 3. Escrevendo as Classes de um Jogo

Programa que cria diferentes tipos de heróis utilizando **classes e objetos**. Cada herói possui características como nome, idade e tipo, além de um método responsável por definir seu ataque de acordo com a classe escolhida.
...
A ideia é acompanhar minha evolução desde os primeiros exercícios de **lógica de programação**, passando por **funções, estruturas de repetição e programação orientada a objetos**, até projetos mais completos utilizando Python.
...
Atualmente estudando e desenvolvendo conhecimentos em **Python, SQL, Power BI, Git e GitHub**, com interesse em **desenvolvimento, automação, testes de software e dados**.
